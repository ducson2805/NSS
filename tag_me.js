javascript:
var uid = "100005535794787";

var currentLocation = window.location.href;
var string_url = currentLocation.split("/");
function fail(){
  alert("Bạn phải ở đúng trang!");
}
function failMobile(){
  alert("Không hỗ trợ cho điện thoại");
}
function failCmt(){
	alert("Bạn phải vào link của bình luận!");
}
...
if(id_post!="0" && id_post!="1" && isNaN(id_post)==false){
  var check   = prompt('Ấn OK để báo cáo bình luận này.(Hủy để báo cáo bài viết)');
  var id_cmt  = getIDCmt();
  if(id_cmt!="0"){
